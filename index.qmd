...
Dygraphs dynamically updates graphs for live data visualization. Dygraphs also provides a dropdown roller that allows users to select a rolling average period, which helps make trends more clearer.

```{=html}
<div id = "graph7" style = "width: 800px; height: 400px; margin: auto; display: block;"></div>
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    ...
    let graph = new Dygraph(document.getElementById("graph7"), data, {
      title: 'Optimized Real-Time Graph',
      xlabel: 'Time',
      ylabel: 'Value',
      labels: ['Time', 'Value'],
      colors: ['blue'],
