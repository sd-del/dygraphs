...
<div id = "graph1" style = "width: 800px; height: 400px; margin: auto; display: block;"></div>
...
```html
<div id = "graph2" style = "width: 800px; height: 400px; margin: auto; display: block;"></div>
...
```html
<div id = "graph3" style = "width: 800px; height: 400px; margin: auto; display: block;"></div>
...
```html
<div id = "graph4" style = "width: 800px; height: 400px; margin: auto; display: block;"></div>
...
```html
<div id = "graph5" style = "width: 800px; height: 400px; margin: auto; display: block;"></div>
...
```html
<div id = "graph6" style = "width: 800px; height: 400px; margin: auto; display: block;"></div>
...
<div id="graph" style="width: 800px; height: 400px; margin: auto; display: block;"></div>

<script>
  document.addEventListener("DOMContentLoaded", function () {
    let data = [];
    const maxPoints = 100; // Keep only the last 100 points

    function updateGraph() {
      const now = new Date().toISOString().split('T')[1].slice(0, 8); // Current time (HH:MM:SS)
      const value = (Math.random() * 100).toFixed(2); // Random value

      data.push([now, parseFloat(value)]);
      if (data.length > maxPoints) data.shift(); // Remove oldest data

      g.updateOptions({ 'file': data });
    }

    // Initialize Dygraph
    const g = new Dygraph(document.getElementById("graph"), data, {
